...
export default (props: Iprops) => {
  ...
  const createFeed = () => {
    ...
    Datafeed.Container.prototype.getTimescaleMarks = function (
      symbolInfo: any,
      startDate: any,
      endDate: any,
      onDataCallback: any,
    ...
    Datafeed.Container.prototype.subscribeBars = (
      symbolInfo: any,
      resolution: any,
  ...
  return (
    <div
      id={symbol}
      key={symbol}
      style={{ height: 400, backgroundColor: "#0000001a" }}
    ></div>
  );
};
