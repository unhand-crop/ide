export const ENGINE_IMAGE_NAME = "engine-image-name";
export const ENGINE_HOST_DOMAIN = "host.lima.internal";
export const ENGINE_CONTAINER_NAME = "unahnd-engine-container";
